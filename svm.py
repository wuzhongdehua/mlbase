# -*- coding: utf-8 -*-
"""
Created on Wed Aug 03 16:37:20 2016
...
inputfile = 'chapter9/demo/data/moment.csv' #数据文件
outputfile1 = 'chapter9/demo/tmp/cm_train.xls' #训练样本混淆矩阵保存路径
outputfile2 = 'chapter9/demo/tmp/cm_test.xls' #测试样本混淆矩阵保存路径
...
import pickle
pickle.dump(model, open('chapter9/demo/tmp/svm.model', 'wb'))
#最后一句保存模型，以后可以通过下面语句重新加载模型：
#model = pickle.load(open('chapter9/demo/tmp/svm.model', 'rb'))
